...
* 🔥 Me enfoco en backend y bases de datos
* 🤝 Me gusta trabajar en proyectos reales y colaborativos
...
`Java` · `Spring Boot` · `MongoDB` · `JavaScript` · `HTML` · `CSS`
...
* 📧 libardojosevilleropaternina@gmail.com
* 🌐 Portafolio: Próximamente

<h3 align="left">Conecta conmigo:</h3>
<p align="left">
  <a href="https://github.com/libardo07" target="_blank">
...
<p align="center">
  <i>"El código es como el fútbol: el trabajo en equipo hace la diferencia." ⚽🔵🔴</i>
</p>
